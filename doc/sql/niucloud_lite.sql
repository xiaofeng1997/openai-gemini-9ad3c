...
-- Script date 2026-04-22 18:43:31
...
--
-- Drop table `nc_account_log`
--
DROP TABLE IF EXISTS nc_account_log;

--
-- Drop table `nc_app_version`
--
DROP TABLE IF EXISTS nc_app_version;

--
-- Drop table `nc_diy_route`
--
DROP TABLE IF EXISTS nc_diy_route;

--
-- Drop table `nc_diy_theme`
--
DROP TABLE IF EXISTS nc_diy_theme;

--
-- Drop table `nc_generate_column`
--
DROP TABLE IF EXISTS nc_generate_column;

--
-- Drop table `nc_generate_table`
--
DROP TABLE IF EXISTS nc_generate_table;
...
--
-- Drop table `nc_jobs_failed`
--
DROP TABLE IF EXISTS nc_jobs_failed;
...
--
-- Drop table `nc_member_account_log`
--
DROP TABLE IF EXISTS nc_member_account_log;

--
-- Drop table `nc_member_address`
--
DROP TABLE IF EXISTS nc_member_address;

--
-- Drop table `nc_member_cash_out`
--
DROP TABLE IF EXISTS nc_member_cash_out;

--
-- Drop table `nc_member_cash_out_account`
--
DROP TABLE IF EXISTS nc_member_cash_out_account;

--
-- Drop table `nc_member_label`
--
DROP TABLE IF EXISTS nc_member_label;

--
-- Drop table `nc_member_level`
--
DROP TABLE IF EXISTS nc_member_level;

--
-- Drop table `nc_member_sign`
--
DROP TABLE IF EXISTS nc_member_sign;

--
-- Drop table `nc_pay`
--
DROP TABLE IF EXISTS nc_pay;

--
-- Drop table `nc_pay_channel`
--
DROP TABLE IF EXISTS nc_pay_channel;

--
-- Drop table `nc_pay_refund`
--
DROP TABLE IF EXISTS nc_pay_refund;

--
-- Drop table `nc_pay_transfer`
--
DROP TABLE IF EXISTS nc_pay_transfer;

--
-- Drop table `nc_pay_transfer_scene`
--
DROP TABLE IF EXISTS nc_pay_transfer_scene;

--
-- Drop table `nc_sys_agreement`
--
DROP TABLE IF EXISTS nc_sys_agreement;

--
-- Drop table `nc_sys_area`
--
DROP TABLE IF EXISTS nc_sys_area;

--
-- Drop table `nc_sys_attachment`
--
DROP TABLE IF EXISTS nc_sys_attachment;

--
-- Drop table `nc_sys_attachment_category`
--
DROP TABLE IF EXISTS nc_sys_attachment_category;

--
-- Drop table `nc_sys_config`
--
DROP TABLE IF EXISTS nc_sys_config;

--
-- Drop table `nc_sys_cron_task`
--
DROP TABLE IF EXISTS nc_sys_cron_task;

--
-- Drop table `nc_sys_dept`
--
DROP TABLE IF EXISTS nc_sys_dept;

--
-- Drop table `nc_sys_dict`
--
DROP TABLE IF EXISTS nc_sys_dict;

--
-- Drop table `nc_sys_menu`
--
DROP TABLE IF EXISTS nc_sys_menu;

--
-- Drop table `nc_sys_position`
--
DROP TABLE IF EXISTS nc_sys_position;

--
-- Drop table `nc_sys_role`
--
DROP TABLE IF EXISTS nc_sys_role;

--
-- Drop table `nc_sys_schedule`
--
DROP TABLE IF EXISTS nc_sys_schedule;

--
-- Drop table `nc_sys_schedule_log`
--
DROP TABLE IF EXISTS nc_sys_schedule_log;

--
-- Drop table `nc_sys_sms_log`
--
DROP TABLE IF EXISTS nc_sys_sms_log;

--
-- Drop table `nc_sys_sms_notice`
--
DROP TABLE IF EXISTS nc_sys_sms_notice;

--
-- Drop table `nc_sys_user`
--
DROP TABLE IF EXISTS nc_sys_user;

--
-- Drop table `nc_sys_user_log`
--
DROP TABLE IF EXISTS nc_sys_user_log;

--
-- Drop table `nc_sys_user_role`
--
DROP TABLE IF EXISTS nc_sys_user_role;

--
-- Drop table `nc_weapp_log`
--
DROP TABLE IF EXISTS nc_weapp_log;

--
-- Drop table `nc_weapp_notice`
--
DROP TABLE IF EXISTS nc_weapp_notice;

--
-- Drop table `nc_wechat_log`
--
DROP TABLE IF EXISTS nc_wechat_log;

--
-- Drop table `nc_wechat_media`
--
DROP TABLE IF EXISTS nc_wechat_media;

--
-- Drop table `nc_wechat_notice`
--
DROP TABLE IF EXISTS nc_wechat_notice;

--
-- Drop table `nc_wechat_reply`
--
DROP TABLE IF EXISTS nc_wechat_reply;


--
-- Create table `nc_wechat_reply`
--
CREATE TABLE nc_wechat_reply (
...
--
-- Create index `key` on table `nc_wechat_notice`
--
ALTER TABLE nc_wechat_notice
ADD UNIQUE INDEX `key` (`key`);

--
-- Create table `nc_wechat_media`
--
CREATE TABLE nc_wechat_media (
...
--
-- Create table `nc_wechat_log`
--
CREATE TABLE nc_wechat_log (
  id int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `key` varchar(50) NOT NULL DEFAULT '' COMMENT '消息标识',
  uid int(11) NOT NULL DEFAULT 0 COMMENT '用户ID',
  member_id int(11) DEFAULT 0 COMMENT '会员ID',
  nickname varchar(100) NOT NULL DEFAULT '' COMMENT '昵称',
  receiver varchar(255) NOT NULL COMMENT '接收人openid',
  params json DEFAULT NULL COMMENT '模板参数',
  content json DEFAULT NULL COMMENT '消息内容',
  status tinyint(4) NOT NULL DEFAULT 0 COMMENT '发送状态：0-发送中，1-发送成功，2-发送失败',
...
CHARACTER SET utf8mb4,
COLLATE utf8mb4_general_ci,
COMMENT = '微信公众号模板消息发送记录';

--
-- Create index `create_time` on table `nc_wechat_log`
--
ALTER TABLE nc_wechat_log
ADD INDEX create_time (create_time);

--
-- Create index `key` on table `nc_wechat_log`
--
ALTER TABLE nc_wechat_log
ADD INDEX `key` (`key`);

--
-- Create index `receiver` on table `nc_wechat_log`
--
ALTER TABLE nc_wechat_log
ADD INDEX receiver (receiver);

--
-- Create index `send_time` on table `nc_wechat_log`
--
ALTER TABLE nc_wechat_log
ADD INDEX send_time (send_time);

--
-- Create table `nc_weapp_notice`
--
CREATE TABLE nc_weapp_notice (
  id int(11) NOT NULL AUTO_INCREMENT COMMENT '标识',
  `key` varchar(50) NOT NULL COMMENT '标识',
...
--
-- Create index `key` on table `nc_weapp_notice`
--
ALTER TABLE nc_weapp_notice
ADD UNIQUE INDEX `key` (`key`);

--
-- Create table `nc_weapp_log`
--
CREATE TABLE nc_weapp_log (
  id int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `key` varchar(50) DEFAULT NULL COMMENT '消息标识',
  uid int(11) DEFAULT 0 COMMENT '用户ID',
  member_id int(11) DEFAULT 0 COMMENT '会员ID',
  nickname varchar(100) DEFAULT '' COMMENT '昵称',
  receiver varchar(255) NOT NULL COMMENT '接收人openid',
  params json NOT NULL DEFAULT '' COMMENT '模板参数',
  content json NOT NULL DEFAULT '' COMMENT '消息内容',
  status tinyint(4) NOT NULL DEFAULT 0 COMMENT '发送状态：0-发送中，1-发送成功，2-发送失败',
  result json NOT NULL COMMENT '发送结果',
...
CHARACTER SET utf8mb4,
COLLATE utf8mb4_general_ci,
COMMENT = '微信小程序模板消息发送记录';

--
-- Create index `create_time` on table `nc_weapp_log`
--
ALTER TABLE nc_weapp_log
ADD INDEX create_time (create_time);

--
-- Create index `key` on table `nc_weapp_log`
--
ALTER TABLE nc_weapp_log
ADD INDEX `key` (`key`);

--
-- Create index `receiver` on table `nc_weapp_log`
--
ALTER TABLE nc_weapp_log
ADD INDEX receiver (receiver);

--
-- Create index `send_time` on table `nc_weapp_log`
--
ALTER TABLE nc_weapp_log
ADD INDEX send_time (send_time);

--
-- Create table `nc_sys_user_role`
--
CREATE TABLE nc_sys_user_role (
  id int(11) NOT NULL AUTO_INCREMENT,
  uid int(11) NOT NULL DEFAULT 0 COMMENT '用户id',
...
CREATE TABLE nc_sys_user (
  ...
  delete_time int(11) NOT NULL DEFAULT 0 COMMENT '删除时间',
  update_time int(11) NOT NULL DEFAULT 0 COMMENT '更新时间',
  status tinyint(4) NOT NULL DEFAULT 1 COMMENT '后台管理员状态 1有效0无效',
  role_ids varchar(255) NOT NULL DEFAULT '' COMMENT '权限组',
  is_admin tinyint(4) NOT NULL DEFAULT 0 COMMENT '是否是管理员',
  dept_id int(10) UNSIGNED DEFAULT 0 COMMENT '所属部门ID',
  position_id int(10) UNSIGNED DEFAULT 0 COMMENT '所属岗位ID',
  PRIMARY KEY (uid),
  INDEX uid (uid)
)
ENGINE = INNODB,
...
--
-- Create index `dept_id` on table `nc_sys_user`
--
ALTER TABLE nc_sys_user
ADD INDEX dept_id (dept_id);

--
-- Create index `position_id` on table `nc_sys_user`
--
ALTER TABLE nc_sys_user
ADD INDEX position_id (position_id);

--
-- Create table `nc_sys_sms_notice`
--
CREATE TABLE nc_sys_sms_notice (
  id int(11) NOT NULL AUTO_INCREMENT COMMENT '标识',
  `key` varchar(50) NOT NULL COMMENT '标识',
  ...
  sms_id varchar(255) NOT NULL DEFAULT '' COMMENT '短信通道（对应短信配置）',
  create_time int(11) NOT NULL DEFAULT 0 COMMENT '添加时间',
  param_json varchar(3000) DEFAULT NULL COMMENT '参数变量',
  PRIMARY KEY (id)
)
ENGINE = INNODB,
AUTO_INCREMENT = 3,
...
--
-- Create index `key` on table `nc_sys_sms_notice`
--
ALTER TABLE nc_sys_sms_notice
ADD UNIQUE INDEX `key` (`key`);

--
-- Create table `nc_sys_sms_log`
--
CREATE TABLE nc_sys_sms_log (
...
--
-- Create table `nc_sys_schedule_log`
--
CREATE TABLE nc_sys_schedule_log (
...
--
-- Create table `nc_sys_position`
--
CREATE TABLE nc_sys_position (
  id int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '岗位ID',
  name varchar(100) NOT NULL COMMENT '岗位名称',
  dept_id int(10) UNSIGNED DEFAULT 0 COMMENT '所属部门ID',
  sort int(11) DEFAULT 0 COMMENT '排序',
  status tinyint(4) DEFAULT 1 COMMENT '状态 1有效0无效',
  create_time int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  update_time int(11) NOT NULL DEFAULT 0 COMMENT '更新时间',
  PRIMARY KEY (id)
)
...
--
-- Create index `dept_id` on table `nc_sys_position`
--
ALTER TABLE nc_sys_position
ADD INDEX dept_id (dept_id);

--
-- Create table `nc_sys_menu`
--
CREATE TABLE nc_sys_menu (
...
--
-- Create table `nc_sys_dept`
--
CREATE TABLE nc_sys_dept (
  id int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '部门ID',
  name varchar(100) NOT NULL COMMENT '部门名称',
  parent_id int(10) UNSIGNED DEFAULT 0 COMMENT '上级部门ID',
  sort int(11) DEFAULT 0 COMMENT '排序',
  status tinyint(4) DEFAULT 1 COMMENT '状态 1有效0无效',
  create_time int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  update_time int(11) NOT NULL DEFAULT 0 COMMENT '更新时间',
...
--
-- Create index `parent_id` on table `nc_sys_dept`
--
ALTER TABLE nc_sys_dept
ADD INDEX parent_id (parent_id);

--
-- Create table `nc_sys_cron_task`
--
CREATE TABLE nc_sys_cron_task (
  id int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Create table `nc_sys_attachment_category`
--
CREATE TABLE nc_sys_attachment_category (
  id int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Create table `nc_sys_attachment`
--
CREATE TABLE nc_sys_attachment (
...
--
-- Create table `nc_pay_transfer_scene`
--
CREATE TABLE nc_pay_transfer_scene (
  id int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE nc_member_sign (
  ...
  is_sign tinyint(4) NOT NULL DEFAULT 0 COMMENT '是否签到（0未签到 1已签到）',
  PRIMARY KEY (sign_id)
)
ENGINE = INNODB,
CHARACTER SET utf8mb4,
...
CREATE TABLE nc_member_level (
  ...
  create_time int(11) NOT NULL DEFAULT 0 COMMENT '添加时间',
  update_time int(11) NOT NULL DEFAULT 0 COMMENT '更新时间',
  level_benefits text DEFAULT NULL COMMENT '等级权益',
  level_gifts text DEFAULT NULL COMMENT '等级礼包',
...
--
-- Create table `nc_member_cash_out_account`
--
CREATE TABLE nc_member_cash_out_account (
...
--
-- Create table `nc_member_cash_out`
--
CREATE TABLE nc_member_cash_out (
  id int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Create table `nc_member_address`
--
CREATE TABLE nc_member_address (
  id int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  member_id int(11) NOT NULL DEFAULT 0 COMMENT '会员id',
...
--
-- Create index `IDX_member_address` on table `nc_member_address`
--
ALTER TABLE nc_member_address
ADD INDEX IDX_member_address (member_id);

--
-- Create table `nc_member_account_log`
--
CREATE TABLE nc_member_account_log (
  id int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Create table `nc_generate_table`
--
CREATE TABLE nc_generate_table (
  id int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
--
-- Create table `nc_generate_column`
--
CREATE TABLE nc_generate_column (
  id int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
-- 
-- Dumping data for table nc_wechat_reply
--
-- Table niucloud_lite.nc_wechat_reply does not contain any data (it is empty)

-- 
-- Dumping data for table nc_wechat_notice
--
INSERT INTO nc_wechat_notice VALUES
(1, 'shop_order_pay', 1, 'grAVDOWur_w-RPRWAQgg5GkNrWHigj1-ImcYnubg874', '', '', 1773907016);

-- 
-- Dumping data for table nc_wechat_media
--
-- Table niucloud_lite.nc_wechat_media does not contain any data (it is empty)

-- 
-- Dumping data for table nc_wechat_log
--
-- Table niucloud_lite.nc_wechat_log does not contain any data (it is empty)

-- 
-- Dumping data for table nc_weapp_notice
--
INSERT INTO nc_weapp_notice VALUES
(1, 'shop_order_pay', 1, 'Fo7Kv2JQZSWjjvn-FECHTHg0KqdGulaGrH-eWX1M-j0', 1773972695);

-- 
-- Dumping data for table nc_weapp_log
--
-- Table niucloud_lite.nc_weapp_log does not contain any data (it is empty)

-- 
-- Dumping data for table nc_sys_user_role
--
INSERT INTO nc_sys_user_role VALUES
(1, 1, '', 0, 1, 1);

-- 
-- Dumping data for table nc_sys_user_log
--
INSERT INTO nc_sys_user_log VALUES
(30, '127.0.0.1', 1, 'admin', '自定义配置\r-设置底部导航\r', '/index.php/adminapi/diy/bottom', '{"key":"app","value":{"backgroundColor":"#ffffff","textColor":"#606266","textHoverColor":"#007aff","type":"1","list":[{"text":"\\u9996\\u9875","link":{"parent":"SYSTEM_LINK","name":"INDEX","title":"\\u9996\\u9875","url":"\\/pages\\/index\\/index","action":"decorate"},"iconPath":"static\\/resource\\/images\\/tabbar\\/index.png","iconSelectPath":"static\\/resource\\/images\\/tabbar\\/index-selected.png"},{"text":"git","link":{"parent":"DIY_LINK","url":"https:\\/\\/gitee.com\\/niucloud-team\\/niucloud-lite-ai","title":"git","name":"DIY_LINK","action":""},"iconSelectPath":"static\\/resource\\/images\\/tabbar\\/git-selected.png","iconPath":"static\\/resource\\/images\\/tabbar\\/git.png"},{"text":"\\u6211\\u7684","link":{"parent":"MEMBER_LINK","name":"MEMBER_CENTER","title":"\\u4e2a\\u4eba\\u4e2d\\u5fc3","url":"\\/pages\\/member\\/index","action":"decorate"},"iconPath":"static\\/resource\\/images\\/tabbar\\/my.png","iconSelectPath":"static\\/resource\\/images\\/tabbar\\/my-selected.png"}]}}', 'POST', 1776844439);

-- 
-- Dumping data for table nc_sys_user
--
INSERT INTO nc_sys_user VALUES
(1, 'admin', '', '$2y$10$i.9RUjuDitKATrGdWdVSfeoPtyT2KFkTbOU1M0/qPPlYCn91P0./W', '', '127.0.0.1', 1776844618, 0, 58, 1, 0, 1776844618, 1, '', 1, 0, 0);

-- 
-- Dumping data for table nc_sys_sms_notice
--
INSERT INTO nc_sys_sms_notice VALUES
(1, 'member_verify_code', '您的手机验证码{code}，请不要轻易告诉其他人', 1, '595621', 1773730359, '{"code":"valid_code"}'),
(2, 'business_notice', '您涉及金额 {amount}，通知时间 {date}，业务备注 {chinese}，其他信息 {others}。请及时核对。', 1, '627997', 1773805570, '{"amount":"amount","date":"date","chinese":"chinese","others":"others"}');

-- 
-- Dumping data for table nc_sys_sms_log
--
INSERT INTO nc_sys_sms_log VALUES
(1, '15234151502', 'niuyun', 'member_verify_code', '595621', '您的手机验证码9966，请不要轻易告诉其他人', '{"code":"9966","param_json":{"code":"valid_code"}}', 'fail', 'ZT-4009:password wrong', 1776733511, 0, 1776733512, 0);

-- 
-- Dumping data for table nc_sys_schedule_log
--
INSERT INTO nc_sys_schedule_log VALUES
(1, 3, '', 'transfer_check_finish', '检验在线转账是否处理完毕', 1775732400, '计划任务：检验在线转账是否处理完毕执行成功', 'success', 'app\\job\\transfer\\schedule\\CheckFinish', 'app\\job\\transfer\\schedule\\CheckFinish');

-- 
-- Dumping data for table nc_sys_schedule
--
INSERT INTO nc_sys_schedule VALUES
(1, 'auto_clear_schedule_log', 1, '{"type":"day","day":1,"hour":1,"min":1}', 0, 0, 0, 0, 0, 0, 0),
(3, 'transfer_check_finish', 1, '{"type":"min","min":5}', 1, 1775732400, 0, 0, 0, 1775732400, 0),
(5, 'auto_clear_user_log', 1, '{"type":"day","day":1,"hour":"19","min":"3"}', 0, 0, 0, 0, 0, 1775732493, 0);

-- 
-- Dumping data for table nc_sys_role
--
INSERT INTO nc_sys_role VALUES
(1, '管理员', '["index","diy","diy_mobile","diy_tabbar_edit","diy_page_decorate_index","diy_page_decorate_member_index","diy_page_list","diy_page_route","diy_bottom","diy_theme_style","attachment","poster_decorate","diy_form_record_list","member","member_list","member_info","member_label","member_level","member_level_list","member_level_edit_page","growth_rule","member_growth","finance","account_list","pay_detail","cash_out_list","member_refund_list","member_refund_detail","member_balance","member_point","member_point_list","point_rule","app","poster_management","sign","sign_set","sign_list","diy_form","diy_form_list","org","channel","pc_config","channel_app_config","app_version_list","h5_config","channel_wechat","weapp_access","aliapp_weapp_access","channel_app","wechat_course","wechat_config","wechat_reply_config","wechat_keyword_reply","wechat_menu","wechat_template_message","weapp_course","weapp_config","weapp_template_message","weapp_code","aliapp_config","aliapp_course","auth","menu","auth_list","auth_role","auth_log","setting","setting_system","setting_system_web","system_agreement","system_agreement_edit","setting_copyright","setting_login","setting_member","setting_member_config","setting_login_register","setting_pay","setting_pay_channel","setting_pay_transfer","cash_out_config","transfer_scene_config","setting_notice","setting_notice_template","setting_notice_records","sms_notice","sms_setting","niu_sms_setting","sms_niu_pay_result","sms_notice_records","setting_tool","map_setting","setting_storage","decorate","page_decorate","form_page_decorate","tool","code","sys_dict_dict_dict_list","tools_schedule","code_edit","tools_schedule_log","tools_dev_example","preview","page_wap_preview"]', 1, 1773720525, 1773720525);

-- 
-- Dumping data for table nc_sys_position
--
INSERT INTO nc_sys_position VALUES
(1, '技术总监', 3, 1, 1, 1773728325, 1774089035),
(2, '高级工程师', 3, 2, 1, 1773728325, 1773728325),
(4, '法务', 2, 0, 0, 1773728325, 1774432259),
(5, '市场经理', 4, 2, 1, 1773728325, 1773728325),
(6, '人事经理', 1, 1, 1, 1773728325, 1774089040),
(7, '人事专员', 4, 2, 1, 1773728325, 1773728325),
(8, '财务经理', 2, 1, 0, 1773728325, 1773827328),
(9, '会计', 4, 2, 0, 1773728325, 1774431384);

-- 
-- Dumping data for table nc_sys_menu
--
INSERT INTO nc_sys_menu VALUES
(11543, 'admin', '首页', '首页', 'index', '', 1, 'nc-iconfont nc-icon-shouyeV6xx1', '', 'index/index', 'index/index', '', 90, 1, 1, 0, 0, 'system', '', ''),
(11544, 'admin', '装修管理', '装修', 'diy', '', 0, 'iconfont iconzhuangxiu3', '', 'diy/index', '', '', 90, 1, 1, 0, 0, 'system', '', ''),
(11545, 'admin', '手机端', '手机端', 'diy_mobile', 'diy', 0, 'element House', '', 'diy/index', '', '', 100, 1, 1, 0, 0, 'system', '', ''),
(11546, 'admin', '编辑', '编辑', 'diy_tabbar_edit', 'diy_mobile', 1, '', 'diy/bottom/edit', 'diy/tabbar_edit', 'diy/tabbar_edit', 'post', 100, 1, 0, 0, 0, 'system', '', 'diy_bottom'),
(11547, 'admin', '首页', '首页', 'diy_page_decorate_index', 'diy_mobile', 1, 'element House', '', 'diy/index', 'diy/index', '', 100, 1, 1, 0, 0, 'system', '', ''),
(11548, 'admin', '底部导航', '底部导航', 'diy_bottom', 'diy_mobile', 1, 'iconfont icondibudaohang', 'diy/bottom', 'diy/tabbar', 'diy/tabbar_edit', 'get', 96, 1, 1, 0, 0, 'system', '', ''),
(11549, 'admin', '保存', '保存', 'diy_tabbar_update', 'diy_bottom', 2, '', 'diy/bottom', '', '', 'post', 0, 1, 1, 0, 0, 'system', '', ''),
(11550, 'admin', '主题风格', '主题风格', 'diy_theme_style', 'diy_mobile', 1, 'element Files', '', 'diy/theme_style', 'diy/theme_style', 'get', 92, 1, 1, 0, 0, 'system', '', ''),
(11551, 'admin', '素材管理', '素材管理', 'attachment', 'diy', 1, 'element Files', 'sys/attachment', 'diy/attachment', 'tools/attachment', 'get', 95, 1, 1, 0, 0, 'system', '', ''),
(11552, 'admin', '删除素材', '删除素材', 'delete_attachment', 'attachment', 2, '', 'sys/attachment/del', '', '', 'delete', 100, 1, 1, 0, 0, 'system', '', ''),
(11553, 'admin', '移动素材', '移动素材', 'move_attachment', 'attachment', 2, '', 'sys/attachment/batchmove', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11554, 'admin', '添加分组', '添加分组', 'add_attachment_category', 'attachment', 2, '', 'sys/attachment/category', '', '', 'post', 100, 1, 1, 0, 0, 'system', '', ''),
(11555, 'admin', '编辑分组', '编辑分组', 'edit_attachment_category', 'attachment', 2, '', 'sys/attachment/category/<id>', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11556, 'admin', '删除分组', '删除分组', 'del_attachment_category', 'attachment', 2, '', 'sys/attachment/category/<id>', '', '', 'delete', 100, 1, 1, 0, 0, 'system', '', ''),
(11557, 'admin', '数据列表', '数据列表', 'diy_form_record_list', 'diy', 1, '', 'diy_form/records', 'diy_form/records', 'diy_form/records', 'get', 0, 1, 0, 0, 0, 'system', '', ''),
(11558, 'admin', '保存', '保存', 'diy_form_update', 'diy', 2, '', 'diy_form', '', '', 'post', 0, 1, 0, 0, 0, 'system', '', ''),
(11559, 'admin', '用户管理', '用户', 'member', '', 0, 'iconfont iconhuiyuan', '', 'member/member', '', '', 89, 1, 1, 0, 0, 'system', '', ''),
(11560, 'admin', '用户列表', '用户列表', 'member_list', 'member', 1, 'iconfont iconhuiyuanliebiao', 'member/member', 'member/member', 'member/member', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11561, 'admin', '编辑用户', '编辑', 'member_update', 'member_list', 2, '', 'member/modify/<member_id>/<field>', '', '', 'put', 0, 1, 1, 0, 0, 'system', '', ''),
(11562, 'admin', '添加用户', '添加', 'member_add', 'member_list', 2, '', 'member/member', '', '', 'post', 0, 1, 1, 0, 0, 'system', '', ''),
(11563, 'admin', '用户导出', '用户导出', 'member_export', 'member_list', 2, '', 'member/member/export', '', '', 'get', 0, 1, 1, 0, 0, 'system', '', ''),
(11564, 'admin', '用户详情', '用户详情', 'member_info', 'member', 1, '', 'member/member/<id>', 'member/detail', 'member/member_detail', 'get', 90, 1, 0, 0, 0, 'system', '', 'member_list'),
(11565, 'admin', '调整用户积分', '调整用户积分', 'adjust_point', 'member_info', 2, '', 'member/account/point', '', '', 'post', 0, 1, 1, 0, 0, 'system', '', ''),
(11566, 'admin', '调整用户余额', '调整用户余额', 'adjust_balance', 'member_info', 2, '', 'member/account/balance', '', '', 'post', 0, 1, 1, 0, 0, 'system', '', ''),
(11567, 'admin', '用户标签', '用户标签', 'member_label', 'member', 1, 'element CollectionTag', 'member/label', 'member/label', 'member/label', 'get', 80, 1, 1, 0, 0, 'system', '', ''),
(11568, 'admin', '编辑标签', '编辑标签', 'member_label_update', 'member_label', 2, '', 'member/label/<id>', '', '', 'put', 0, 1, 1, 0, 0, 'system', '', ''),
(11569, 'admin', '添加标签', '添加标签', 'member_label_add', 'member_label', 2, '', 'member/label', '', '', 'post', 0, 1, 1, 0, 0, 'system', '', ''),
(11570, 'admin', '删除标签', '删除标签', 'member_label_delete', 'member_label', 2, '', 'member/label/<id>', '', '', 'delete', 0, 1, 1, 0, 0, 'system', '', ''),
(11571, 'admin', '用户等级', '用户等级', 'member_level', 'member', 0, 'element CollectionTag', 'member/level', 'member/level', 'member/level', 'get', 79, 1, 1, 0, 0, 'system', '', ''),
(11572, 'admin', '等级列表', '用户等级', 'member_level_list', 'member_level', 1, 'element CollectionTag', 'member/level', 'member/level', 'member/level', 'get', 50, 1, 1, 0, 0, 'system', '', ''),
(11573, 'admin', '添加等级', '添加等级', 'member_level_add', 'member_level_list', 2, '', 'member/level', '', '', 'post', 0, 1, 1, 0, 0, 'system', '', ''),
(11574, 'admin', '编辑等级', '编辑等级', 'member_level_edit', 'member_level_list', 2, '', 'member/level/<id>', '', '', 'put', 0, 1, 1, 0, 0, 'system', '', ''),
(11575, 'admin', '删除等级', '删除等级', 'member_level_delete', 'member_level_list', 2, '', 'member/level/<id>', '', '', 'delete', 0, 1, 1, 0, 0, 'system', '', ''),
(11576, 'admin', '添加/编辑等级', '添加/编辑等级', 'member_level_edit_page', 'member_level', 1, '', '', 'member/level_edit', 'member/level_edit', '', 49, 1, 0, 0, 0, 'system', '', ''),
(11577, 'admin', '用户等级信息', '用户等级信息', 'member_level_info', 'member_level_edit_page', 2, '', 'member/level/<id>', '', '', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11578, 'admin', '成长值规则', '成长值规则', 'growth_rule', 'member_level', 1, '', 'member/config/growth_rule', 'setting/growth_rule', 'setting/growth_rule', 'get', 49, 1, 1, 0, 0, 'system', '', ''),
(11579, 'admin', '设置成长值规则', '设置成长值规则', 'set_growth_rule', 'growth_rule', 2, '', 'member/config/growth_rule', '', '', 'post', 100, 1, 1, 0, 0, 'system', '', ''),
(11580, 'admin', '用户成长值', '用户成长值', 'member_growth', 'member', 1, 'iconfont iconjifen-xianxing', 'member/account/growth', 'member/growth', 'member/growth', 'get', 49, 1, 0, 0, 0, 'system', '', ''),
(11581, 'admin', '财务管理', '财务', 'finance', '', 0, 'iconfont iconcaiwu1', '', 'finance/account', '', '', 88, 1, 1, 0, 0, 'system', '', ''),
(11582, 'admin', '财务流水', '财务流水', 'account_list', 'finance', 1, 'element Postcard', 'finance/account', 'finance/account', 'finance/account', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11583, 'admin', '支付单据详情', '支付单据详情', 'pay_detail', 'finance', 1, 'element Postcard', 'pay/detail', 'finance/pay/detail', 'finance/pay_detail', 'get', 98, 1, 0, 0, 0, 'system', '', ''),
(11584, 'admin', '用户提现', '用户提现', 'cash_out_list', 'finance', 1, 'element Postcard', 'member/cash_out', 'finance/cash_out', 'finance/cash_out', 'get', 97, 1, 1, 0, 0, 'system', '', ''),
(11585, 'admin', '提现审核', '提现审核', 'cash_out_audit', 'cash_out_list', 2, '', 'member/cash_out/audit/<id>/<action>', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11586, 'admin', '转账', '转账', 'cash_out_transfer', 'cash_out_list', 2, '', 'member/cash_out/transfer/<id>', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11587, 'admin', '用户退款', '用户退款', 'member_refund_list', 'finance', 1, 'iconfont iconhuiyuantixian', 'pay/refund', 'finance/refund', 'finance/pay_refund', 'get', 96, 1, 1, 0, 0, 'system', '', ''),
(11588, 'admin', '转账', '转账', 'cash_out_transfer', 'member_refund_list', 2, '', 'pay/refund/transfer/<id>', '', '', 'post', 100, 1, 1, 0, 0, 'system', '', ''),
(11589, 'admin', '用户积分', '用户积分', 'member_point', 'finance', 0, 'iconfont iconjifen-xianxing', '', 'member/point', '', '', 51, 1, 1, 0, 0, 'system', '', ''),
(11590, 'admin', '积分明细', '积分明细', 'member_point_list', 'member_point', 1, 'iconfont iconjifen-xianxing', 'member/account/point', 'member/point', 'member/point', 'get', 120, 1, 1, 0, 0, 'system', '', ''),
(11591, 'admin', '积分规则', '积分规则', 'point_rule', 'member_point', 1, '', 'member/config/point_rule', 'setting/point_rule', 'setting/point_rule', 'get', 110, 1, 1, 0, 0, 'system', '', ''),
(11592, 'admin', '积分规则', '设置积分规则', 'set_point_rule', 'point_rule', 2, '', 'member/config/point_rule', '', '', 'post', 100, 1, 1, 0, 0, 'system', '', ''),
(11593, 'admin', '用户余额', '用户余额', 'member_balance', 'finance', 1, 'element Money', 'member/account/balance', 'member/balance', 'member/balance', 'get', 60, 1, 1, 0, 0, 'system', '', ''),
(11594, 'admin', '退款详情', '退款详情', 'member_refund_detail', 'finance', 1, 'iconfont iconhuiyuantixian', 'pay/refund/<refund_no>', 'finance/refund/detail', 'finance/refund_detail', 'get', 95, 1, 0, 0, 0, 'system', '', 'member_refund_list'),
(11595, 'admin', '渠道管理', '渠道', 'channel', '', 0, 'iconfont iconqudao', '', '', '', '', 85, 1, 1, 0, 0, 'system', '', ''),
(11596, 'admin', 'PC端', 'PC端', 'pc_config', 'channel', 1, 'iconfont icondesktop', 'channel/pc/config', 'channel/pc/config', 'channel/pc/config', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11597, 'admin', '保存', '保存', 'save_pc_config', 'pc_config', 2, '', 'channel/pc/config', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11598, 'admin', 'H5端', 'H5端', 'h5_config', 'channel', 1, 'iconfont iconh5e', 'channel/h5/config', 'channel/h5/config', 'channel/h5/config', 'put', 90, 1, 1, 0, 0, 'system', '', ''),
(11599, 'admin', '保存', '保存', 'save_h5_config', 'h5_config', 2, '', 'channel/h5/config', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11600, 'admin', '微信公众号', '微信公众号', 'channel_wechat', 'channel', 1, 'iconfont iconweixingongzhonghao1', '', 'channel/wechat', 'channel/wechat/access', '', 80, 1, 1, 0, 0, 'system', '', ''),
(11601, 'admin', '微信小程序', '微信小程序', 'weapp_access', 'channel', 1, 'iconfont iconxiaochengxushezhi', 'weapp/access', 'channel/weapp', 'channel/weapp/access', 'get', 70, 1, 1, 0, 0, 'system', '', ''),
(11602, 'admin', '支付宝小程序', '支付宝小程序', 'aliapp_weapp_access', 'channel', 1, 'iconfont iconzhifubao', 'aliapp/access', 'channel/aliapp', 'channel/aliapp/access', 'get', 60, 1, 1, 0, 0, 'system', '', ''),
(11603, 'admin', '发布教程', '发布教程', 'wechat_course', 'channel', 1, '', 'wechat/course', 'channel/wechat/course', 'channel/wechat/course', 'get', 0, 1, 0, 0, 0, 'system', '', ''),
(11604, 'admin', '公众号配置', '公众号配置', 'wechat_config', 'channel', 1, '', 'wechat/config', 'channel/wechat/config', 'channel/wechat/config', 'get', 0, 1, 0, 0, 0, 'system', '', ''),
(11605, 'admin', '保存', '保存', 'save_wechat_config', 'wechat_config', 2, '', 'wechat/config', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11606, 'admin', '公众号回复配置', '公众号回复配置', 'wechat_reply_config', 'channel', 1, '', '', 'channel/wechat/reply', 'channel/wechat/reply', 'get', 0, 1, 0, 0, 0, 'system', '', ''),
(11607, 'admin', '默认回复设置', '默认回复设置', 'wechat_default_reply_set', 'wechat_reply_config', 2, '', 'wechat/reply/default', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11608, 'admin', '关注回复设置', '关注回复设置', 'wechat_subscribe_reply_set', 'wechat_reply_config', 2, '', 'wechat/reply/subscribe', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11609, 'admin', '消息记录', '消息记录', 'wechat_log', 'channel', 1, 'iconfont iconjilu', 'wechat/log', 'channel/wechat/log', 'channel/wechat/log', 'get', 75, 1, 0, 0, 0, 'system', '', ''),
(11610, 'admin', '关键字回复添加/编辑', '关键字回复添加/编辑', 'wechat_keyword_reply', 'channel', 1, '', 'wechat/reply/keywords/<id>', 'channel/wechat/keyword_reply_edit', 'channel/wechat/keyword_reply_edit', 'get', 0, 1, 0, 0, 0, 'system', '', ''),
(11611, 'admin', '关键字回复添加', '关键字回复添加', 'wechat_keyword_reply_add', 'wechat_keyword_reply', 2, '', 'wechat/reply/keywords/<id>', '', '', 'post', 0, 1, 1, 0, 0, 'system', '', ''),
(11612, 'admin', '关键字回复编辑', '关键字回复编辑', 'wechat_keyword_reply_edit', 'wechat_keyword_reply', 2, '', 'wechat/reply/keywords/<id>', '', '', 'put', 0, 1, 1, 0, 0, 'system', '', ''),
(11613, 'admin', '关键字回复删除', '关键字回复编辑', 'wechat_keyword_reply_delete', 'wechat_keyword_reply', 2, '', 'wechat/reply/keywords/<id>', '', '', 'delete', 0, 1, 1, 0, 0, 'system', '', ''),
(11614, 'admin', '自定义菜单', '自定义菜单', 'wechat_menu', 'channel', 1, '', 'wechat/menu', 'channel/wechat/menu', 'channel/wechat/menu', 'get', 0, 1, 0, 0, 0, 'system', '', ''),
(11615, 'admin', '保存', '保存', 'save_wechat_menu', 'wechat_menu', 2, '', 'wechat/menu', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11616, 'admin', '模板消息', '模板消息', 'wechat_template_message', 'channel', 1, '', 'wechat/template', 'channel/wechat/message', 'channel/wechat/template', 'get', 0, 1, 0, 0, 0, 'system', '', ''),
(11617, 'admin', '同步', '同步', 'sync_wechat_template_message', 'wechat_template_message', 2, '', 'wechat/template/sync', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11618, 'admin', '配置教程', '配置教程', 'weapp_course', 'channel', 1, '', 'weapp/course', 'channel/weapp/course', 'channel/weapp/course', 'get', 0, 1, 0, 0, 0, 'system', '', ''),
(11619, 'admin', '小程序配置', '小程序配置', 'weapp_config', 'channel', 1, '', 'weapp/config', 'channel/weapp/config', 'channel/weapp/config', 'get', 0, 1, 0, 0, 0, 'system', '', ''),
(11620, 'admin', '保存', '保存', 'save_weapp_config', 'weapp_config', 2, '', 'weapp/config', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11621, 'admin', '订阅消息', '订阅消息', 'weapp_template_message', 'channel', 1, '', 'weapp/template', 'channel/weapp/message', 'channel/weapp/template', 'get', 0, 1, 0, 0, 0, 'system', '', ''),
(11622, 'admin', '同步', '同步', 'sync_weapp_template_message', 'weapp_template_message', 2, '', 'weapp/template/sync', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11623, 'admin', '消息记录', '消息记录', 'weapp_log', 'channel', 1, 'iconfont iconjilu', 'weapp/log', 'channel/weapp/log', 'channel/weapp/log', 'get', 75, 1, 0, 0, 0, 'system', '', ''),
(11624, 'admin', '小程序发布', '小程序发布', 'weapp_code', 'channel', 1, '', 'weapp/code', 'channel/weapp/code', 'channel/weapp/code', 'get', 0, 1, 0, 0, 0, 'system', '', ''),
(11625, 'admin', '一键云端发布', '一键云端发布', 'add_weapp_code', 'weapp_code', 2, '', 'weapp/version', '', '', 'post', 100, 1, 1, 0, 0, 'system', '', ''),
(11626, 'admin', '支付宝配置', '支付宝配置', 'aliapp_config', 'channel', 1, '', 'aliapp/config', 'channel/aliapp/config', 'channel/aliapp/config', 'get', 0, 1, 0, 0, 0, 'system', '', ''),
(11627, 'admin', '保存', '保存', 'save_aliapp_config', 'aliapp_config', 2, '', 'aliapp/config', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11628, 'admin', '配置教程', '配置教程', 'aliapp_course', 'channel', 1, '', 'aliapp/course', 'channel/aliapp/course', 'channel/aliapp/course', 'get', 0, 1, 0, 0, 0, 'system', '', ''),
(11629, 'admin', 'App端', 'App端', 'channel_app', 'channel', 1, '', '', 'channel/app', 'channel/app/access', '', 50, 1, 1, 0, 0, 'system', '', ''),
(11630, 'admin', 'App端配置', 'app端配置', 'channel_app_config', 'channel', 1, '', 'channel/app/config', 'channel/app/config', 'channel/app/config', 'get', 100, 1, 0, 0, 0, 'system', '', ''),
(11631, 'admin', '设置app端配置', '设置app端配置', 'set_channel_app_config', 'channel_app_config', 2, '', 'channel/app/config', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11632, 'admin', 'APP版本管理', '版本管理', 'app_version_list', 'channel', 1, '', 'channel/app/version', 'channel/app/version', 'channel/app/version', 'get', 100, 1, 0, 0, 0, 'system', '', ''),
(11633, 'admin', '权限管理', '权限', 'auth', '', 0, 'iconfont iconquanxian', '', '', '', '', 84, 1, 1, 0, 0, 'system', '', ''),
(11634, 'admin', '管理员', '管理员', 'auth_list', 'auth', 1, 'element Lock', 'user', 'auth/user', 'auth/user', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11635, 'admin', '管理员信息', '管理员信息', 'auth_user_detail', 'auth_list', 2, '', 'user/<uid>', '', '', 'get', 1, 1, 1, 0, 0, 'system', '', ''),
(11636, 'admin', '添加管理员', '添加管理员', 'add_user', 'auth_list', 2, '', 'user', '', '', 'post', 100, 1, 1, 0, 0, 'system', '', ''),
(11637, 'admin', '编辑管理员', '编辑管理员', 'edit_user', 'auth_list', 2, '', 'user/<uid>', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11638, 'admin', '修改管理员属性', '修改管理员属性', 'edit_user_field', 'auth_list', 2, '', 'user/<uid>/<field>', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11639, 'admin', '锁定', '锁定', 'lock_user', 'auth_list', 2, '', 'user/lock/<uid>', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11640, 'admin', '解锁', '解锁用户', 'unlock_user', 'auth_list', 2, '', 'user/unlock/<uid>', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11641, 'admin', '删除管理员', '删除管理员', 'delete_user', 'auth_list', 2, '', 'user/<uid>', '', '', 'delete', 100, 1, 1, 0, 0, 'system', '', ''),
(11642, 'admin', '菜单', '菜单', 'menu', 'auth', 1, '', 'sys/menu', 'tools/menu', 'auth/menu', 'get', 104, 1, 1, 0, 0, 'system', '', ''),
(11643, 'admin', '新增', '新增', 'auth_menu_add', 'menu', 2, '', 'sys/menu', '', '', 'post', 1, 1, 1, 0, 0, 'system', '', ''),
(11644, 'admin', '编辑', '编辑', 'auth_menu_update', 'menu', 2, '', 'sys/menu/<menu_key>', '', '', 'put', 1, 1, 1, 0, 0, 'system', '', ''),
(11645, 'admin', '删除', '删除', 'auth_menu_del', 'menu', 2, '', 'sys/menu', '', '', 'delete', 1, 1, 1, 0, 0, 'system', '', ''),
(11646, 'admin', '详情', '详情', 'auth_menu_info', 'menu', 2, '', 'sys/menu/<menu_key>', '', '', 'get', 0, 1, 1, 0, 0, 'system', '', ''),
(11647, 'admin', '管理员角色', '管理员角色', 'auth_role', 'auth', 1, 'iconfont iconhuiyuanliebiao', 'sys/role', 'setting/auth/role', 'auth/role', 'get', 99, 1, 1, 0, 0, 'system', '', ''),
(11648, 'admin', '新增', '新增', 'auth_role_add', 'auth_role', 2, '', 'sys/role', '', '', 'post', 1, 1, 1, 0, 0, 'system', '', ''),
(11649, 'admin', '编辑', '编辑', 'auth_role_update', 'auth_role', 2, '', 'sys/role/<role_id>', '', '', 'put', 1, 1, 1, 0, 0, 'system', '', ''),
(11650, 'admin', '删除', '删除', 'auth_role_del', 'auth_role', 2, '', 'sys/role/<role_id>', '', '', 'delete', 1, 1, 1, 0, 0, 'system', '', ''),
(11651, 'admin', '操作日志', '操作日志', 'auth_log', 'auth', 1, 'element Document', 'sys/log', 'setting/auth/log', 'auth/log', 'get', 98, 1, 1, 0, 0, 'system', '', ''),
(11652, 'admin', '组织管理', '组织', 'org', '', 0, 'iconfont iconyingyong21', '', 'sys/dept', '', '', 86, 1, 1, 0, 0, 'system', '', ''),
(11653, 'admin', '部门管理', '部门', 'dept', 'org', 1, 'element OfficeBuilding', 'sys/dept', 'sys/dept', 'sys/dept', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11654, 'admin', '添加部门', '添加部门', 'dept_add', 'dept', 2, '', 'sys/dept', '', '', 'post', 100, 1, 1, 0, 0, 'system', '', ''),
(11655, 'admin', '编辑部门', '编辑部门', 'dept_edit', 'dept', 2, '', 'sys/dept/<id>', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11656, 'admin', '删除部门', '删除部门', 'dept_delete', 'dept', 2, '', 'sys/dept/<id>', '', '', 'delete', 100, 1, 1, 0, 0, 'system', '', ''),
(11657, 'admin', '部门详情', '部门详情', 'dept_detail', 'dept', 2, '', 'sys/dept/<id>', '', '', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11658, 'admin', '岗位管理', '岗位', 'position', 'org', 1, 'element UserFilled', 'sys/position', 'sys/position', 'sys/position', 'get', 99, 1, 1, 0, 0, 'system', '', ''),
(11659, 'admin', '添加岗位', '添加岗位', 'position_add', 'position', 2, '', 'sys/position', '', '', 'post', 100, 1, 1, 0, 0, 'system', '', ''),
(11660, 'admin', '编辑岗位', '编辑岗位', 'position_edit', 'position', 2, '', 'sys/position/<id>', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11661, 'admin', '删除岗位', '删除岗位', 'position_delete', 'position', 2, '', 'sys/position/<id>', '', '', 'delete', 100, 1, 1, 0, 0, 'system', '', ''),
(11662, 'admin', '岗位详情', '岗位详情', 'position_detail', 'position', 2, '', 'sys/position/<id>', '', '', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11663, 'admin', '系统设置', '设置', 'setting', '', 0, 'iconfont iconshezhi3', '', 'setting/system', '', '', 83, 1, 1, 0, 0, 'system', '', ''),
(11664, 'admin', '网站设置', '网站设置', 'setting_system', 'setting', 0, 'element Basketball', '', 'setting/system', '', '', 100, 1, 1, 0, 0, 'system', '', ''),
(11665, 'admin', '基础设置', '基础设置', 'setting_system_web', 'setting_system', 1, 'element Basketball', 'sys/config/website', 'setting/system', 'setting/system', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11666, 'admin', '保存', '保存', 'save_base_setting', 'setting_system_web', 2, '', 'sys/config/website', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11667, 'admin', '版权设置', '版权设置', 'setting_copyright', 'setting_system', 1, 'iconfont iconbanquan1', 'sys/config/copyright', 'setting/copyright', 'setting/copyright', 'get', 90, 1, 1, 0, 0, 'system', '', ''),
(11668, 'admin', '保存', '保存', 'save_setting_copyright', 'setting_copyright', 2, '', 'sys/config/copyright', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11669, 'admin', '网站协议', '网站协议', 'system_agreement', 'setting_system', 1, 'element Notebook', 'sys/agreement', 'setting/agreement', 'setting/agreement', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11670, 'admin', '协议编辑', '协议编辑', 'system_agreement_edit', 'setting_system', 1, '', '', 'setting/agreement/edit', 'setting/agreement_edit', '', 100, 1, 0, 0, 0, 'system', '', ''),
(11671, 'admin', '获取协议信息', '获取协议信息', 'get_system_agreement', 'system_agreement_edit', 2, '', 'sys/agreement/<key>', '', '', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11672, 'admin', '修改协议信息', '修改协议信息', 'edit_system_agreement', 'system_agreement_edit', 2, '', 'sys/agreement/<key>', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11673, 'admin', '用户设置', '用户设置', 'setting_member', 'setting', 0, 'iconfont iconjiaoseyonghu', '', 'setting/member', '', '', 71, 1, 1, 0, 0, 'system', '', ''),
(11674, 'admin', '用户设置', '用户设置', 'setting_member_config', 'setting_member', 1, 'iconfont iconjiaoseyonghu', 'member/config/member', 'setting/member', 'setting/member', 'get', 71, 1, 1, 0, 0, 'system', '', ''),
(11675, 'admin', '保存', '保存', 'save_setting_member_config', 'setting_member_config', 2, '', 'member/config/member', '', '', 'post', 100, 1, 1, 0, 0, 'system', '', ''),
(11676, 'admin', '注册登录', '注册登录', 'setting_login_register', 'setting_member', 1, 'iconfont iconzhuceshezhi', 'member/config/login', 'setting/login', 'setting/login', 'get', 70, 1, 1, 0, 0, 'system', '', ''),
(11677, 'admin', '保存', '保存', 'save_setting_login_register', 'setting_login_register', 2, '', 'member/config/login', '', '', 'post', 100, 1, 1, 0, 0, 'system', '', ''),
(11678, 'admin', '支付管理', '支付管理', 'setting_pay', 'setting', 1, 'element Wallet', '', 'setting/pay/channel', '', 'get', 60, 1, 1, 0, 0, 'system', '', ''),
(11679, 'admin', '支付设置', '支付设置', 'setting_pay_channel', 'setting_pay', 1, '', 'pay/channel/lists', 'setting/pay/channel', 'setting/pay', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11680, 'admin', '设置', '设置', 'setting_pay_channel_set', 'setting_pay_channel', 2, '', 'pay/channel/set/<channel>/<type>', '', '', 'post', 100, 1, 1, 0, 0, 'system', '', ''),
(11681, 'admin', '打款设置', '打款设置', 'setting_pay_transfer', 'setting_pay', 1, '', 'pay/transfer', 'setting/pay/transfer', 'setting/transfer', 'get', 90, 1, 1, 0, 0, 'system', '', ''),
(11682, 'admin', '设置', '设置', 'setting_pay_transfer_set', 'setting_pay_transfer', 2, '', 'pay/transfer', '', '', 'post', 90, 1, 1, 0, 0, 'system', '', ''),
(11683, 'admin', '提现设置', '提现设置', 'cash_out_config', 'setting_pay', 1, 'element Postcard', 'member/config/cash_out', 'setting/cash_out', 'setting/cash_out', 'get', 59, 1, 1, 0, 0, 'system', '', ''),
(11684, 'admin', '设置', '设置', 'cash_out_config_set', 'cash_out_config', 2, '', 'member/config/cash_out', '', '', 'post', 90, 1, 1, 0, 0, 'system', '', ''),
(11685, 'admin', '转账场景', '转账场景', 'transfer_scene_config', 'setting_pay', 1, 'element Postcard', '', 'setting/transfer_scene', 'setting/transfer_scene', 'get', 59, 1, 1, 0, 0, 'system', '', ''),
(11686, 'admin', '短信管理', '短信管理', 'sms_notice', 'setting', 0, 'element Message', '', 'setting/sms/setting', '', '', 40, 1, 1, 0, 0, 'system', '', ''),
(11687, 'admin', '短信设置', '短信设置', 'sms_setting', 'sms_notice', 1, '', 'notice/notice/sms', 'setting/sms/setting', 'setting/sms', 'get', 12, 1, 1, 0, 0, 'system', '', ''),
(11688, 'admin', '获取短信配置', '获取短信配置', 'get_sms_config', 'sms_setting', 2, '', 'notice/notice/sms/<sms_type>', '', '', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11689, 'admin', '修改短信配置', '修改短信配置', 'set_sms_config', 'sms_setting', 2, '', 'notice/notice/sms/<sms_type>', '', '', 'post', 100, 1, 1, 0, 0, 'system', '', ''),
(11690, 'admin', '牛云短信配置', '牛云设置', 'niu_sms_setting', 'sms_notice', 1, '', '', 'setting/niusms/setting', 'setting/sms_niu', 'get', 12, 1, 0, 0, 0, 'system', '', ''),
(11691, 'admin', '订单结果页', '订单结果页', 'sms_niu_pay_result', 'sms_notice', 1, '', '', 'setting/sms/pay', 'setting/sms_niu_pay_result', 'get', 12, 1, 0, 0, 0, 'system', '', ''),
(11692, 'admin', '发送记录', '发送记录', 'sms_notice_records', 'sms_notice', 1, '', 'notice/sms/log', 'setting/sms/records', 'setting/sms_records', 'get', 11, 1, 1, 0, 0, 'system', '', ''),
(11693, 'admin', '发送记录详情', '发送记录详情', 'sms_log_detail', 'sms_notice_records', 2, '', 'notice/sms/log/<id>', '', '', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11694, 'admin', '短信模板', '短信模板', 'sms_template', 'sms_notice', 1, '', 'notice/sms/notice', 'setting/sms/template', 'setting/sms_template', 'get', 10, 1, 1, 0, 0, 'system', '', ''),
(11695, 'admin', '获取短信模板列表', '获取短信模板列表', 'get_sms_template_list', 'sms_template', 2, '', 'notice/sms/notice', '', '', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11696, 'admin', '获取短信模板详情', '获取短信模板详情', 'get_sms_template_info', 'sms_template', 2, '', 'notice/sms/notice/<key>', '', '', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11697, 'admin', '编辑短信模板', '编辑短信模板', 'edit_sms_template', 'sms_template', 2, '', 'notice/sms/notice/edit', '', '', 'post', 100, 1, 1, 0, 0, 'system', '', ''),
(11698, 'admin', '修改短信模板状态', '修改短信模板状态', 'edit_sms_template_status', 'sms_template', 2, '', 'notice/sms/notice/editstatus', '', '', 'post', 100, 1, 1, 0, 0, 'system', '', ''),
(11699, 'admin', '系统工具', '系统工具', 'setting_tool', 'setting', 0, 'element FolderChecked', '', 'setting/agreement', '', '', 20, 1, 1, 0, 0, 'system', '', ''),
(11700, 'admin', '地图秘钥', '地图秘钥', 'map_setting', 'setting_tool', 1, 'element Message', 'sys/config/map', 'setting/map', 'setting/map', 'get', 99, 1, 1, 0, 0, 'system', '', ''),
(11701, 'admin', '保存', '保存', 'save_layout_setting', 'map_setting', 2, '', 'sys/config/map', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11702, 'admin', '存储设置', '存储设置', 'setting_storage', 'setting_tool', 1, 'element FolderChecked', 'sys/storage', 'setting/storage', 'setting/storage', 'get', 98, 1, 1, 0, 0, 'system', '', ''),
(11703, 'admin', '获取存储配置', '获取存储配置', 'setting_storage_value', 'setting_storage', 2, '', 'sys/storage/<storage_type>', '', '', 'get', 100, 1, 1, 0, 0, 'system', '', ''),
(11704, 'admin', '存储设置修改', '存储设置修改', 'edit_setting_storage', 'setting_storage', 2, '', 'sys/storage/<storage_type>', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11705, 'admin', '页面装修', '页面装修', 'decorate', '', 0, '', '', '', '', '', 21, 1, 0, 0, 0, 'system', '', 'diy'),
(11706, 'admin', '装修', '装修', 'page_decorate', 'decorate', 1, '', 'diy/diy/<id>', 'decorate/edit', 'diy/edit', 'put', 0, 1, 0, 0, 0, 'system', '', ''),
(11707, 'admin', '开发管理', '开发', 'tool', '', 0, 'element Edit', '', '', '', '', 20, 1, 1, 0, 0, 'system', '', ''),
(11708, 'admin', '代码生成', '代码生成', 'code', 'tool', 1, 'iconfont icondaimashengcheng', 'generator/generator', 'tools/code', 'tools/code/index', 'get', 118, 1, 1, 0, 0, 'system', '', ''),
(11709, 'admin', '数据表编辑', '数据表编辑', 'code_edit', 'tool', 1, '', '', 'tools/code/edit', 'tools/code/edit', '', 100, 1, 0, 0, 0, 'system', '', ''),
(11710, 'admin', '添加数据表', '添加数据表', 'add_generator', 'code_edit', 2, '', 'generator/generator', '', '', 'post', 100, 1, 1, 0, 0, 'system', '', ''),
(11711, 'admin', '编辑数据表', '编辑数据表', 'edit_generator', 'code_edit', 2, '', 'generator/generator/<id>', '', '', 'put', 100, 1, 1, 0, 0, 'system', '', ''),
(11712, 'admin', '删除数据表', '删除数据表', 'delete_generator', 'code_edit', 2, '', 'generator/generator/<id>', '', '', 'delete', 100, 1, 1, 0, 0, 'system', '', ''),
(11713, 'admin', '代码生成', '代码生成', 'generator_download', 'code_edit', 2, '', 'generator/download', '', '', 'post', 100, 1, 1, 0, 0, 'system', '', ''),
(11714, 'admin', '数据字典', '数据字典', 'sys_dict_dict_dict_list', 'tool', 1, 'iconfont iconwenzhangguanli1', 'dict/post/post', 'tools/list', 'dict/list', 'get', 106, 1, 1, 0, 0, 'system', '', ''),
(11715, 'admin', '数据字典添加', '数据字典添加', 'sys_dict_dict_dict_add', 'sys_dict_dict_dict_list', 2, '', 'dict', 'edit', 'dict/edit', 'post', 4, 1, 1, 0, 0, 'system', '', ''),
(11716, 'admin', '编辑', '编辑', 'sys_dict_dict_dict_edit', 'sys_dict_dict_dict_list', 2, '', 'dict/<id>', 'edit', 'dict/edit', 'put', 3, 1, 1, 0, 0, 'system', '', ''),
(11717, 'admin', '删除', '删除', 'sys_dict_dict_dict_delete', 'sys_dict_dict_dict_list', 2, '', 'dict/<id>', '', '', 'delete', 2, 1, 1, 0, 0, 'system', '', ''),
(11718, 'admin', '计划任务', '计划任务', 'tools_schedule', 'tool', 1, 'iconfont iconjihuarenwu', 'sys/schedule/list', 'tools/schedule', 'tools/schedule', '', 103, 1, 1, 0, 0, 'system', '', ''),
(11719, 'admin', '新增', '新增', 'schedule_add', 'tools_schedule', 2, '', 'sys/schedule', '', '', 'post', 4, 1, 1, 0, 0, 'system', '', ''),
(11720, 'admin', '编辑', '编辑', 'schedule_update', 'tools_schedule', 2, '', 'sys/schedule/<id>', '', '', 'put', 3, 1, 1, 0, 0, 'system', '', ''),
(11721, 'admin', '设置状态', '设置状态', 'schedule_set_status', 'tools_schedule', 2, '', 'schedule/modify/status/<id>', '', '', 'put', 2, 1, 1, 0, 0, 'system', '', ''),
(11722, 'admin', '删除', '删除', 'schedule_del', 'tools_schedule', 2, '', 'sys/schedule/<id>', '', '', 'delete', 1, 1, 1, 0, 0, 'system', '', ''),
(11723, 'admin', '执行日志', '执行日志', 'tools_schedule_log', 'tool', 1, 'iconfont iconjihuarenwu', 'sys/schedule/log/list', 'tools/schedule_log', 'tools/schedule_log', '', 100, 1, 0, 0, 0, 'system', '', '');

-- 
-- Dumping data for table nc_sys_dict
--
-- Table niucloud_lite.nc_sys_dict does not contain any data (it is empty)

-- 
-- Dumping data for table nc_sys_dept
--
INSERT INTO nc_sys_dept VALUES
(1, '总公司', 0, 1, 1, 1773826305, 1774433070),
(2, '测试部', 4, 1, 1, 1773826305, 1774433068),
(3, '市场部', 1, 2, 1, 1773826305, 1774433069),
(4, '人事部', 1, 3, 1, 1773826305, 1774432692),
(5, '财务部', 1, 4, 1, 1773826305, 1774432701);

-- 
-- Dumping data for table nc_sys_cron_task
--
-- Table niucloud_lite.nc_sys_cron_task does not contain any data (it is empty)

-- 
-- Dumping data for table nc_sys_config
--
INSERT INTO nc_sys_config VALUES
(1, 'SMS', '{"default":"niuyun","niuyun":{"username":"xxs1234","password":"ztbnus8w","signature":"\\u3010\\u5c71\\u897f\\u725b\\u4e4b\\u4e91\\u7f51\\u7edc\\u79d1\\u6280\\u6709\\u9650\\u516c\\u53f8\\u3011"},"aliyun":{"sign":"1","app_key":"2","secret_key":"3"},"tencent":{"sign":"42","app_id":"52","secret_id":"62","secret_key":"7"}}', 1, 1773634430, 1774005769),
(2, 'LOGIN', '{"is_username":1,"is_mobile":1,"is_auth_register":1,"is_force_access_user_info":0,"is_bind_mobile":0,"agreement_show":0,"bg_url":"","desc":"\\u7cbe\\u9009\\u597d\\u7269\\uff0c\\u8d2d\\u7269\\u4f18\\u60e0\\u7684\\u7701\\u94b1\\u5e73\\u53f0"}', 1, 1773649840, 1773649840),
(3, 'WECHAT', '{"wechat_name":"niuclould-single","wechat_original":"gh_1800f7cdc2e2","app_id":"wx6d239b9ba59783b4","app_secret":"","qr_code":"","token":"token","encoding_aes_key":"","encryption_type":"not_encrypt","is_authorization":0}', 1, 1773815964, 1773815964),
(4, 'GROWTH_RULE', '{"grant":{"member_register":{"is_use":0,"growth":12,"content":"\\u4f1a\\u5458\\u6ce8\\u518c\\u5956\\u52b112\\u6210\\u957f\\u503c"}},"consume":[]}', 1, 1773825093, 1775564054),
(5, 'WEB_SITE_INFO', '{"site_name":"NIUCLOUD ADMIN","logo":"","desc":"","latitude":"","longitude":"","province_id":0,"city_id":0,"district_id":0,"address":"","full_address":"","phone":"","business_hours":"","front_end_name":"niucloud","front_end_logo":"","front_end_icon":"","icon":""}', 1, 1773970444, 1775121996),
(6, 'SERVICE_INFO', '{"wechat_code":"","enterprise_wechat":"","tel":""}', 1, 1773970444, 1775121996),
(7, 'MEMBER_NO', '{"no":8}', 1, 1773970576, 1776853777),
(8, 'diy_bottom_app', '{"backgroundColor":"#ffffff","textColor":"#606266","textHoverColor":"#007aff","type":"1","list":[{"text":"\\u9996\\u9875","link":{"parent":"SYSTEM_LINK","name":"INDEX","title":"\\u9996\\u9875","url":"\\/pages\\/index\\/index","action":"decorate"},"iconPath":"static\\/resource\\/images\\/tabbar\\/index.png","iconSelectPath":"static\\/resource\\/images\\/tabbar\\/index-selected.png"},{"text":"git","link":{"parent":"DIY_LINK","url":"https:\\/\\/gitee.com\\/niucloud-team\\/niucloud-lite-ai","title":"git","name":"DIY_LINK","action":""},"iconSelectPath":"static\\/resource\\/images\\/tabbar\\/git-selected.png","iconPath":"static\\/resource\\/images\\/tabbar\\/git.png"},{"text":"\\u6211\\u7684","link":{"parent":"MEMBER_LINK","name":"MEMBER_CENTER","title":"\\u4e2a\\u4eba\\u4e2d\\u5fc3","url":"\\/pages\\/member\\/index","action":"decorate"},"iconPath":"static\\/resource\\/images\\/tabbar\\/my.png","iconSelectPath":"static\\/resource\\/images\\/tabbar\\/my-selected.png"}]}', 1, 1773971038, 1776844439),
(9, 'MEMBER', '{"prefix":"nc","length":"6","form_id":""}', 1, 1774055402, 1774055402),
(10, 'SIGN_CONFIG', '{"is_use":true,"sign_period":"233","day_award":{"balance":{"is_use":1,"money":12},"point":{"is_use":1,"num":"3"}},"continue_award":[{"continue_sign":"12","continue_tag":"uDXQKeOHah","receive_limit":1,"receive_num":0,"balance":{"is_use":1,"money":323},"point":[]},{"continue_sign":"25","continue_tag":"uB7tb121P8","receive_limit":1,"receive_num":0,"balance":{"is_use":1,"money":12},"point":{"is_use":1,"num":"44"}}],"rule_explain":"333"}', 1, 1774427361, 1774427361),
(11, 'POINT_RULE', '{"grant":{"member_register":{"is_use":0,"point":22,"content":"\\u4f1a\\u5458\\u6ce8\\u518c\\u5956\\u52b1\\u79ef\\u520622"}},"consume":[]}', 1, 1774493313, 1775564072),
(12, 'admin_login', '{"is_captcha":0,"bg":""}', 1, 1775117899, 1775121995),
(13, 'MAPKEY', '{"map_type":"tianditu","key":"","amap_key":"","tianditu_map_key":"111","tianditu_map_web_key":"333","is_open":1,"valid_time":5}', 1, 1775186814, 1775186814);

-- 
-- Dumping data for table nc_sys_attachment_category
--
-- Table niucloud_lite.nc_sys_attachment_category does not contain any data (it is empty)

-- 
-- Dumping data for table nc_sys_attachment
--
-- Table niucloud_lite.nc_sys_attachment does not contain any data (it is empty)

-- 
-- Dumping data for table nc_sys_area
--
INSERT INTO nc_sys_area VALUES
...
-- 
-- Dumping data for table nc_sys_agreement
--
-- Table niucloud_lite.nc_sys_agreement does not contain any data (it is empty)

-- 
-- Dumping data for table nc_pay_transfer_scene
--
-- Table niucloud_lite.nc_pay_transfer_scene does not contain any data (it is empty)

-- 
-- Dumping data for table nc_pay_transfer
--
-- Table niucloud_lite.nc_pay_transfer does not contain any data (it is empty)

-- 
-- Dumping data for table nc_pay_refund
--
-- Table niucloud_lite.nc_pay_refund does not contain any data (it is empty)

-- 
-- Dumping data for table nc_pay_channel
--
INSERT INTO nc_pay_channel VALUES
(1, 'balancepay', 'pc', '[]', 1776159345, 1776159345, 1, 0),
(2, 'wechatpay', 'pc', '{"mch_id":"","mch_secret_key":"","mch_secret_cert":"","mch_public_cert_path":"","wechat_public_cert_path":"","wechat_public_cert_id":""}', 1776159345, 1776159345, 0, 1),
(3, 'alipay', 'pc', '{"app_id":"","app_secret_cert":"","app_public_cert_path":"","alipay_public_cert_path":"","alipay_root_cert_path":""}', 1776159345, 1776159345, 0, 2),
(4, 'balancepay', 'h5', '[]', 1776159345, 1776159345, 1, 0),
(5, 'wechatpay', 'h5', '{"mch_id":"","mch_secret_key":"","mch_secret_cert":"","mch_public_cert_path":"","wechat_public_cert_path":"","wechat_public_cert_id":""}', 1776159345, 1776159345, 0, 1),
(6, 'alipay', 'h5', '{"app_id":"","app_secret_cert":"","app_public_cert_path":"","alipay_public_cert_path":"","alipay_root_cert_path":""}', 1776159345, 1776159345, 0, 2),
(7, 'balancepay', 'app', '[]', 1776159345, 1776159345, 1, 0),
(8, 'wechatpay', 'app', '{"mch_id":"","mch_secret_key":"","mch_secret_cert":"","mch_public_cert_path":"","wechat_public_cert_path":"","wechat_public_cert_id":""}', 1776159345, 1776159345, 0, 1),
(9, 'alipay', 'app', '{"app_id":"","app_secret_cert":"","app_public_cert_path":"","alipay_public_cert_path":"","alipay_root_cert_path":""}', 1776159345, 1776159345, 0, 2),
(10, 'balancepay', 'wechat', '[]', 1776159345, 1776159345, 0, 0),
(11, 'wechatpay', 'wechat', '{"mch_id":"","mch_secret_key":"","mch_secret_cert":"","mch_public_cert_path":"","wechat_public_cert_path":"","wechat_public_cert_id":""}', 1776159345, 1776159345, 0, 1),
(12, 'alipay', 'wechat', '{"app_id":"","app_secret_cert":"","app_public_cert_path":"","alipay_public_cert_path":"","alipay_root_cert_path":""}', 1776159346, 1776159346, 0, 2),
(13, 'balancepay', 'weapp', '[]', 1776159346, 1776159346, 0, 0),
(14, 'wechatpay', 'weapp', '{"mch_id":"","mch_secret_key":"","mch_secret_cert":"","mch_public_cert_path":"","wechat_public_cert_path":"","wechat_public_cert_id":""}', 1776159346, 1776159346, 0, 1),
(15, 'alipay', 'weapp', '{"app_id":"","app_secret_cert":"","app_public_cert_path":"","alipay_public_cert_path":"","alipay_root_cert_path":""}', 1776159346, 1776159346, 0, 2);

-- 
-- Dumping data for table nc_pay
--
-- Table niucloud_lite.nc_pay does not contain any data (it is empty)

-- 
-- Dumping data for table nc_member_sign
--
-- Table niucloud_lite.nc_member_sign does not contain any data (it is empty)

-- 
-- Dumping data for table nc_member_level
--
INSERT INTO nc_member_level VALUES
(1, 'vip会员', 100, '', 1, 1774426653, 1775564046, '{"discount":{"is_use":0,"discount":"8"}}', '{"balance":{"is_use":0,"money":"100"},"point":{"is_use":0,"num":"12"}}');

-- 
-- Dumping data for table nc_member_label
--
-- Table niucloud_lite.nc_member_label does not contain any data (it is empty)

-- 
-- Dumping data for table nc_member_cash_out_account
--
-- Table niucloud_lite.nc_member_cash_out_account does not contain any data (it is empty)

-- 
-- Dumping data for table nc_member_cash_out
--
-- Table niucloud_lite.nc_member_cash_out does not contain any data (it is empty)

-- 
-- Dumping data for table nc_member_address
--
-- Table niucloud_lite.nc_member_address does not contain any data (it is empty)

-- 
-- Dumping data for table nc_member_account_log
--
-- Table niucloud_lite.nc_member_account_log does not contain any data (it is empty)

-- 
-- Dumping data for table nc_jobs_failed
--
-- Table niucloud_lite.nc_jobs_failed does not contain any data (it is empty)

-- 
-- Dumping data for table nc_jobs
--
-- Table niucloud_lite.nc_jobs does not contain any data (it is empty)

-- 
-- Dumping data for table nc_generate_table
--
-- Table niucloud_lite.nc_generate_table does not contain any data (it is empty)

-- 
-- Dumping data for table nc_generate_column
--
-- Table niucloud_lite.nc_generate_column does not contain any data (it is empty)

-- 
-- Dumping data for table nc_diy_theme
--
INSERT INTO nc_diy_theme VALUES
(8, '默认绿色', '{"--page-bg-color":"#F6F6F6","--primary-color":"#00c905","--primary-color-light":"rgba(51, 51, 51, 0.1)","--primary-color-light2":"rgba(51, 51, 51, 0.8)","--primary-help-color2":"rgba(51, 51, 51, 1)","--primary-color-dark":"#999999","--primary-color-disabled":"#CCCCCC"}', 0, 1774062580, 1775628714),
(9, '活力橙色', '{"--primary-color":"#FF6B35","--primary-light-color":"#FFB347","--secondary-color":"#FFF3E0","--secondary-light-color":"#ffffff","--secondary-dark-color":"#FFE0B2","--primary-text-color":"#3c3c3c","--secondary-text-color":"#555555"}', 0, 1774062580, 1774062580),
(10, '优雅紫色', '{"--primary-color":"#9C27B0","--primary-light-color":"#CE93D8","--secondary-color":"#F3E5F5","--secondary-light-color":"#ffffff","--secondary-dark-color":"#E1BEE7","--primary-text-color":"#3c3c3c","--secondary-text-color":"#555555"}', 0, 1774062580, 1774062580),
(11, '清新蓝色', '{"--primary-color":"#2196F3","--primary-light-color":"#90CAF9","--secondary-color":"#E3F2FD","--secondary-light-color":"#ffffff","--secondary-dark-color":"#BBDEFB","--primary-text-color":"#3c3c3c","--secondary-text-color":"#555555"}', 1, 1774062580, 1774062580),
(12, '商务灰色', '{"--primary-color":"#607D8B","--primary-light-color":"#B0BEC5","--secondary-color":"#ECEFF1","--secondary-light-color":"#ffffff","--secondary-dark-color":"#CFD8DC","--primary-text-color":"#3c3c3c","--secondary-text-color":"#555555"}', 0, 1774062580, 1774062580);

-- 
-- Dumping data for table nc_diy_route
--
-- Table niucloud_lite.nc_diy_route does not contain any data (it is empty)

-- 
-- Dumping data for table nc_app_version
--
-- Table niucloud_lite.nc_app_version does not contain any data (it is empty)

-- 
-- Dumping data for table nc_account_log
--
-- Table niucloud_lite.nc_account_log does not contain any data (it is empty)
