...
use app\dict\sys\SmsDict as SysSmsDict;
 ...
 */
class SysSmsLog extends BaseModel
{
    ...
    public function getNameAttr($value, $data)
    {
        $name = '';
        if (!empty($data['key'])) {
            $temp = CoreSmsTemplateData::getSmsTemplate($data['key']);
            $name = $temp['name'] ?? '';
        }
        return $name;
    }
    ...
    public function getStatusNameAttr($value, $data)
    {
        ...
        if (!empty($data['status'])) {
            $name = SysSmsDict::getStatusType()[$data['status']] ?? '';
        }
        return $name;
    }
    ...
    public function getSmsTypeNameAttr($value, $data)
    {
        ...
        $temp = SysSmsDict::getType()[$data['sms_type']] ?? [];
        return $temp['name'] ?? '';
    }
