...
class WebApiGenerator extends BaseGenerator
{
    ...
    {
        $dir = dirname(app()->getRootPath()).DIRECTORY_SEPARATOR.'frontend'.DIRECTORY_SEPARATOR.'admin'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'api'.DIRECTORY_SEPARATOR;
        $this->checkDir($dir);
        return $dir;
    }
    ...
    public function getImport()
    {
        ...
        $file = $dir.DIRECTORY_SEPARATOR.'frontend'.DIRECTORY_SEPARATOR.'admin'.DIRECTORY_SEPARATOR.'admin'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'api'.DIRECTORY_SEPARATOR.$this->moduleName.'.ts';
    ...
    {
        $dir = $this->outDir . 'frontend'.DIRECTORY_SEPARATOR.'admin'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'api'.DIRECTORY_SEPARATOR;
        $this->checkDir($dir);
        return $dir;
    }
    ...
    {
        $dir = $this->rootDir . DIRECTORY_SEPARATOR.'frontend'.DIRECTORY_SEPARATOR.'admin'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'api'.DIRECTORY_SEPARATOR;
        $this->checkDir($dir);
        return $dir;
    }
