...
//            $this->getDictDataContent(),
    ...
    public function getEditPath()
    {
        ...
        return "import "."Edit from '@/views/".$this->moduleName."/".$path.$file_name."'";
    }
    ...
    {
        $dir = dirname(app()->getRootPath()) .DIRECTORY_SEPARATOR.'frontend'.DIRECTORY_SEPARATOR.'admin'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'app'.DIRECTORY_SEPARATOR.'views'.DIRECTORY_SEPARATOR;
        $this->checkDir($dir);
        return $dir;
    }
    ...
    {
        $dir = $this->outDir . 'frontend'.DIRECTORY_SEPARATOR.'admin'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'views'.DIRECTORY_SEPARATOR . $this->moduleName . DIRECTORY_SEPARATOR;
        $this->checkDir($dir);
        return $dir;
    }
    ...
    {
        $dir = $this->rootDir . DIRECTORY_SEPARATOR.'frontend'.DIRECTORY_SEPARATOR.'admin'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'views'.DIRECTORY_SEPARATOR . $this->moduleName . DIRECTORY_SEPARATOR;
        $this->checkDir($dir);
        return $dir;
    }
    ...
    {
        $dir = 'frontend/admin/src/views/' . $this->moduleName . '/';
        return $dir;
    }
    /**
     * 生成的文件名
