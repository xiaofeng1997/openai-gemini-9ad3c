...
class WebEditGenerator extends BaseGenerator
{
    ...
    public function getModuleOutDir()
    {
        ...
        $dir = dirname(app()->getRootPath()) . DIRECTORY_SEPARATOR.'frontend'.DIRECTORY_SEPARATOR.'admin'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'views'.DIRECTORY_SEPARATOR . $this->moduleName . DIRECTORY_SEPARATOR;
        $this->checkDir($dir);
        return $dir;
    }
