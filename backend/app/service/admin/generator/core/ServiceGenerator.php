...
class ServiceGenerator extends BaseGenerator
{
    ...
    {
        $dir = $this->outDir .'backend'.DIRECTORY_SEPARATOR.'app'.DIRECTORY_SEPARATOR.'service'.DIRECTORY_SEPARATOR.'admin'.DIRECTORY_SEPARATOR;
    ...
    {
        $dir = $this->rootDir . DIRECTORY_SEPARATOR.'backend'.DIRECTORY_SEPARATOR.'app'.DIRECTORY_SEPARATOR.'service'.DIRECTORY_SEPARATOR.'admin'.DIRECTORY_SEPARATOR;
