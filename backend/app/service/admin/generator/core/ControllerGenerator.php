...
class ControllerGenerator extends BaseGenerator
{
    ...
    {
        $dir = $this->outDir . DIRECTORY_SEPARATOR.'backend'.DIRECTORY_SEPARATOR.'app'.DIRECTORY_SEPARATOR.'adminapi'.DIRECTORY_SEPARATOR.'controller'.DIRECTORY_SEPARATOR;
    ...
    public function getObjectOutDir()
    {
        ...
        $dir = $this->rootDir . DIRECTORY_SEPARATOR.'backend'.DIRECTORY_SEPARATOR.'app'.DIRECTORY_SEPARATOR.'adminapi'.DIRECTORY_SEPARATOR.'controller'.DIRECTORY_SEPARATOR;
    ...
    public function getFilePath()
    {
        ...
        $dir = 'backend/app/adminapi/controller/';
