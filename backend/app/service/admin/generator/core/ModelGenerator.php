...
class ModelGenerator extends BaseGenerator
{
    ...
    {
        $dir = $this->outDir . DIRECTORY_SEPARATOR.'backend'.DIRECTORY_SEPARATOR.'app'.DIRECTORY_SEPARATOR.'model'.DIRECTORY_SEPARATOR;
    ...
    {
        $dir = $this->rootDir . DIRECTORY_SEPARATOR.'backend'.DIRECTORY_SEPARATOR.'app'.DIRECTORY_SEPARATOR.'model'.DIRECTORY_SEPARATOR;
