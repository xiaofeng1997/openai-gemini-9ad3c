...
class ValidateGenerator extends BaseGenerator
{
    ...
    public function getPackageName()
    {
        if(!empty($this->moduleName))
        {
            return 'app\validate\\'.$this->moduleName;
        }else{
            return 'app\\validate';
        }
    }
    ...
    {
        $dir = $this->outDir . 'backend'.DIRECTORY_SEPARATOR.'app'.DIRECTORY_SEPARATOR.'validate'.DIRECTORY_SEPARATOR;
    ...
    {
        $dir = $this->rootDir . DIRECTORY_SEPARATOR.'backend'.DIRECTORY_SEPARATOR.'app'.DIRECTORY_SEPARATOR.'validate'.DIRECTORY_SEPARATOR;
