...
class MemberService extends BaseAdminService
{
    ...
    {
        return MemberAccountTypeDict::getBenifitRule();
    }
    ...
    {
        return MemberAccountTypeDict::getMemberGiftRule();
    }
    ...
    {
        return MemberAccountTypeDict::getGrowthRule();
    }
    ...
    {
        return MemberAccountTypeDict::getPointGrantRule();
    }
