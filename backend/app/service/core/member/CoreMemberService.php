...
class CoreMemberService extends BaseCoreService
{
    ...
    public static function sendGrowth(int $member_id, string $key, array $param = [])
    {
        ...
        $dict = MemberAccountTypeDict::getGrowthRule();
    ...
    public static function sendPoint(int $member_id, string $key, array $param = [])
    {
        ...
        $dict = MemberAccountTypeDict::getPointGrantRule();
        if (!isset($dict[$key])) return true;
        $dict = $dict[$key];
    ...
    {
        try {
            $dict = MemberAccountTypeDict::getMemberGiftRule();
    ...
    {
        $dict =     MemberAccountTypeDict::getBenifitRule();
    ...
    {
        $dict =     MemberAccountTypeDict::getPointConsumRule();
