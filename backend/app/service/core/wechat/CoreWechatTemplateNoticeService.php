...
use app\model\wechat\WechatNotice;
 ...
 * 核心微信公众号模板通知服务层
 */
class CoreWechatTemplateNoticeService extends BaseCoreService
{
    public function __construct()
    {
        parent::__construct();
        $this->model = new WechatNotice();
    }
    ...
    {
        $notice = CoreWechatTemplateData::getWechatTemplates();
        if (!empty($key)) {
            return $notice[$key] ?? [];
        }
        return $notice;
