        ...
        <view class="fixed w-full z-2  !bg-[var(--page-bg-color)]">
            ...
            <view
                ...
                <view class="flex flex-col items-center w-full"
                      ...
                      :class="{'pt-[12rpx]': !Object.keys(cashOutConfigObj).length || (Object.keys(cashOutConfigObj).length  && cashOutConfigObj.is_open != 1)}">
...
import { cashOutConfig, getBalanceListAll, rechargeConfig } from '@/api/member';
