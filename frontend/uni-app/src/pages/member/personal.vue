                ...
                <u-cell :title="t('mobile')" :titleStyle="{'font-size': '28rpx'}">
                    <template #value>
                        ...
                        <view v-else>
                            ...
                            <!-- #ifdef H5 -->
                            <button @click="redirect({ url: '/pages/auth/bind' })" class="bg-transparent w-[170rpx] p-[0] rounded-[100rpx] text-[var(--primary-color)] !border-[2rpx] !border-solid border-[var(--primary-color)] text-[24rpx] h-[54rpx] flex-center">{{ t('bindMobile') }}</button>
                            <!-- #endif -->
