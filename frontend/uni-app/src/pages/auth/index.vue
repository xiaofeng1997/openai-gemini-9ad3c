        ...
        <view class="w-screen h-screen" :style="warpStyle">
            ...
            <view class="mx-[var(--sidebar-m)] px-[var(--pad-sidebar-m)]">
                <view class="pt-[154rpx] flex justify-center">
                    ...
                    <view v-else class="h-[90rpx] w-[300rpx]">
                        <image class="h-[90rpx] w-[300rpx]" :src="img('static/resource/images/logo.png')" mode="aspectFit" />
                    </view>
                </view>
                ...
                <view class="mt-[181rpx]">
                    ...
                    <view v-if="loginConfig.is_mobile" class="mb-[40rpx] w-full flex items-center justify-center">
                        <!-- #ifndef MP -->
                        <button class="w-[630rpx] h-[88rpx] !mx-[0] !bg-[#fff] border-[var(--primary-color)] border-solid border-[2rpx] text-[26rpx] rounded-[44rpx] leading-[84rpx] !text-[var(--primary-color)]" @click="redirect({ url: '/pages/auth/login',param:{type:'mobile'}})">{{ t('mobileLogin') }}</button>
                        <!-- #endif -->
                        ...
                        <button v-if="authRegisterLogin && loginConfig.is_mobile"
                                ...
                                @click="redirect({ url: '/pages/auth/login',param:{type:'mobile'}})">
                            {{ t('otherMobileLogin') }}
                        </button>
                        <button v-else
                                class="w-[630rpx] h-[88rpx] !mx-[0] !bg-[#fff] border-[var(--primary-color)] border-solid border-[2rpx] text-[26rpx] rounded-[44rpx] leading-[84rpx] !text-[var(--primary-color)]"
                    ...
                    <view v-else-if="!loginConfig.is_mobile && loginConfig.is_username" class="w-full flex items-center justify-center">
                        <button class="w-[630rpx] h-[88rpx] !mx-[0] !bg-[#fff] !border-[var(--primary-color)] border-solid border-[2rpx] text-[26rpx] rounded-[44rpx] leading-[84rpx] !text-[var(--primary-color)]" @click="redirect({ url: '/pages/auth/login',param:{type:'username'}})">{{ t('accountLogin') }}</button>
                    </view>
                    ...
                    <view class="footer w-full" v-if="loginConfig.is_mobile && loginConfig.is_username">
                        ...
                        <view class="flex justify-center">
                            <text @click="redirect({ url: '/pages/auth/login',param:{type:'username'}})" class="w-[66rpx] h-[66rpx] flex items-center justify-center iconfont iconmima6Vmm border-[2rpx] rounded-[50%] border-solid border-[#ddd] !text-[26rpx]"></text>
                        </view>
                    </view>
...
const warpStyle = computed(() => {
    ...
    if (configStore.login.bg_url) {
        ...
        style += 'background-image:url(' + img('static/resource/images/h5_login_bg.jpg') + ');';
        style += 'background-position: top;';
        style += 'background-repeat: no-repeat;';
