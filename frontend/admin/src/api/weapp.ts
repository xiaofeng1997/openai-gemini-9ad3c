...
export function setTemplate(params: Record<string, any>) {
    return request.put('weapp/template', params, { showSuccessMessage: true })
}
 ...
 * @returns
 */
export function getWeappLogList(params: Record<string, any>) {
    return request.get('weapp/log', { params })
}
 ...
 * @returns
 */
export function getWeappLogInfo(id: number) {
    return request.get(`weapp/log/${id}`)
}
