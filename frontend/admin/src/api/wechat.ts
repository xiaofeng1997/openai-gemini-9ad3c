 ...
 * @returns
 */
export function getWechatNoticeList() {
    return request.get('wechat/template')
}
 ...
 * @returns
 */
export function setTemplate(params: Record<string, any>) {
    return request.put('wechat/template', params, { showSuccessMessage: true })
}
 ...
 * @returns
 */
export function getWechatLog(params: Record<string, any>) {
    return request.get('wechat/log', { params })
}
 ...
 * @returns
 */
export function getWechatLogDetail(id: number) {
    return request.get(`wechat/log/${id}`)
}
