...
export function getDeptList(params: Record<string, any>) {
    return request.get('sys/dept', { params })
}
 ...
 * @returns
 */
export function addDept(params: Record<string, any>) {
    return request.post(`sys/dept`, params, { showSuccessMessage: true })
}
 ...
 * @param params
 */
export function editDept(params: Record<string, any>) {
    return request.put(`sys/dept/${ params.id }`, params, { showSuccessMessage: true })
}
...
export function deleteDept(id: number) {
    return request.delete(`sys/dept/${ id }`, { showSuccessMessage: true })
}
...
export function getPositionList(params: Record<string, any>) {
    return request.get('sys/position', { params })
}
...
export function getPositionAll() {
    return request.get('sys/position/all')
}
 ...
 * @param dept_id
 */
export function getPositionByDept(dept_id: number) {
    return request.get(`sys/position/dept/${ dept_id }`)
}
 ...
 * @param id
 */
export function getPositionInfo(id: number) {
    return request.get(`sys/position/${ id }`)
}
...
export function addPosition(params: Record<string, any>) {
    return request.post(`sys/position`, params, { showSuccessMessage: true })
}
...
export function editPosition(params: Record<string, any>) {
    return request.put(`sys/position/${ params.id }`, params, { showSuccessMessage: true })
}
...
export function deletePosition(id: number) {
    return request.delete(`sys/position/${ id }`, { showSuccessMessage: true })
}
