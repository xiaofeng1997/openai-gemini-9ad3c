        ...
        if (className == 'box1') {
            ...
            if (oldLeft == 0 && oldTop == 0) {
                ...
                if (width == minWidth && height == minHeight) {
                    ...
                    // 宽度 = 最小值，高度 > 最小值，left = 最小宽度，top = 不予处理
                    left = minWidth
                } else if (width > minWidth && height == minHeight) {
                    // 宽度 > 最小值，高度 = 最小值，left = 不予处理，top = 最小高度
                    top = minHeight
                } else if (width > minWidth && height > minHeight) {
                    // 宽度 > 最小值，高度 > 最小值，left = 不予处理，top = 不予处理
                }
                ...
                if (width == minWidth && height == minHeight) {
                    ...
                    // 宽度 = 最小值，高度 > 最小值，left = 最小宽度，top = 元素上偏移位置
                    left = minWidth
                    top = box.offsetTop
                } else if (width > minWidth && height == minHeight) {
                    // 宽度 > 最小值，高度 = 最小值，left = 不予处理，top = 元素上偏移位置
                    top = box.offsetTop
                } else if (width > minWidth && height > minHeight) {
                    // 宽度 > 最小值，高度 > 最小值，left = 不予处理，top = 不予处理
                }
                ...
                if (width == minWidth && height == minHeight) {
                    ...
                    // 宽度 = 最小值，高度 > 最小值，left = 元素左偏移位置，top = 0
                    left = box.offsetLeft
                    top = 0
                } else if (width > minWidth && height == minHeight) {
                    // 宽度 > 最小值，高度 = 最小值，left = 不予处理，top = 元素上偏移位置
                ...
                if (width == minWidth && height == minHeight) {
                    ...
                    // 宽度 = 最小值，高度 > 最小值，left = 元素左偏移位置，top = 元素上偏移位置
                    left = box.offsetLeft
                    top = box.offsetTop
                } else if (width > minWidth && height == minHeight) {
                    // 宽度 > 最小值，高度 = 最小值，left = 不予处理，top = 元素上偏移位置
