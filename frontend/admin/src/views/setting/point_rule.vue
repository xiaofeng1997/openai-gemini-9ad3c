...
import { t } from '@/lang'
import { getPointRuleConfig, setPointRuleConfig } from '@/api/member'
import Test from '@/utils/test'
import pointRuleRegister from '@/views/member/components/point-rule-register.vue'
