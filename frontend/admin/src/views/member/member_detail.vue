                ...
                <div class="member-info absolute w-[250px]">
                    <div class="flex items-center">
                        ...
                        <span class="flex items-end text-[14px]">
                            ...
                            <img class="w-[50px] h-[50px] inline-block rounded-full" v-else src="@/assets/images/member_head.png" alt="">
...
<!--                                            </el-tooltip>-->
        ...
        <el-card class="box-card !border-none" shadow="never">
            ...
            <div class="flex items-center mt-[15px]">
                <span class="text-[14px] w-[130px] text-right flex-shrink-0 mr-[20px]">{{ t('身份证号') }}</span>
                <span class="text-[14px] text-[#666666]">
