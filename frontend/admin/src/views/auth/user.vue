        ...
        <el-card class="box-card !border-none" shadow="never">
            ...
            <div>
                <el-table :data="userTableData.data" size="large" v-loading="userTableData.loading">
                    ...
                    <el-table-column :label="t('headImg')" width="100" align="left">
                        <template #default="{ row }">
                            <div class="w-[35px] h-[35px] flex items-center justify-center">
                                ...
                                <img v-else src="@/assets/images/member_head.png" class="w-[35px] rounded-full" />
                            </div>
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column prop="dept_name" :label="t('deptName')" min-width="120" show-overflow-tooltip>
                        <template #default="{ row }">
                            <span>{{ row.dept?.name || '--' }}</span>
                        </template>
                    </el-table-column>
                    <el-table-column prop="position_name" :label="t('positionName')" min-width="120" show-overflow-tooltip>
                        <template #default="{ row }">
...
import { t } from '@/lang'
import { getUserList, lockUser, unlockUser,deleteUser } from '@/api/user'
...
const editUserDialog = ref<InstanceType<typeof EditUser> | null>(null)
