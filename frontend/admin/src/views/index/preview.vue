...
const loadingDev = ref(false) // 加载开发环境配�?
const timeIframe = ref(0) // iframe打开时间
const difference = ref(0) // 检测页面加载差异，小于1000毫秒，则配置wap端域�?
...
const setDomain = () => {
    if (route.query.page) {
        ...
        // errorCorrectionLevel：密度容错率L（低）H(�?
        ...
        // 如果同步发送消息的 uni-app没有接收到回应，则定时发送消�?
        let sendCount = 0
        const timeInterVal = setInterval(() => {
            // 接收 uni-app 发送的消息 或�?发�?0次后未响应，则停止发�?
