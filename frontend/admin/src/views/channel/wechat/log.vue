...
import { t } from '@/lang'
import { getWechatLog, getWechatNoticeList } from '@/api/wechat'
import RecordsInfo from './components/wechat-log-info.vue'
...
const activeName = ref('/channel/wechat/log')
