        ...
        <el-card class="box-card mt-[15px] pt-[20px] !border-none" shadow="never">
            <div class="flex">
                ...
                <div>
                    ...
                    <div class="w-[100%] mt-[10px]">
                        <img class="w-[100%]" src="@/assets/images/setting/wechat_1.png" />
                    </div>
                    <p class="flex items-center text-[14px] mt-[20px]">{{ t('writingTipsOne5') }}</p>
                    <div class="w-[100%] mt-[10px]">
                        <img class="w-[100%]" src="@/assets/images/setting/wechat_4.png" />
                    </div>
                </div>
            </div>
            <div class="flex mt-[40px]">
                ...
                <div>
                    ...
                    <div class="w-[100%] mt-[10px]">
                        <img class="w-[100%]" src="@/assets/images/setting/wechat_2.png" />
                    </div>
                </div>
            </div>
            <div class="flex mt-[40px]">
                ...
                <div>
                    ...
                    <div class="w-[100%] mt-[10px]">
                        <img class="w-[100%]" src="@/assets/images/setting/wechat_3.png" />
                    </div>
                </div>
            </div>
        </el-card>
