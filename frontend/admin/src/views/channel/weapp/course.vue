        ...
        <el-card class="box-card mt-[15px] !border-none" shadow="never">
            <div class="flex">
                ...
                <div>
                    ...
                    <div class="w-[100%] mt-[10px]">
                        <img class="w-[100%]" src="@/assets/images/setting/weapp_1.png" />
                    </div>
                </div>
            </div>
            <div class="flex mt-[40px]">
                ...
                <div>
                    ...
                    <div class="w-[100%] mt-[10px]">
                        <img class="w-[100%]" src="@/assets/images/setting/weapp_2.png" />
                    </div>
                </div>
            </div>
            <div class="flex mt-[40px]">
                ...
                <div>
                    ...
                    <div class="w-[100%] mt-[10px]">
                        <img class="w-[100%]" src="@/assets/images/setting/weapp_3.png" />
                    </div>
                </div>
            </div>
            <div class="flex mt-[40px]">
                ...
                <div>
                    ...
                    <div class="w-[100%] mt-[10px]">
                        <img class="w-[100%]" src="@/assets/images/setting/weapp_4.png" />
                    </div>
                </div>
            </div>
        </el-card>
