        ...
        <el-card class="box-card mt-[15px] !border-none" shadow="never">
            <div class="flex">
                ...
                <div>
                    ...
                    <div class="w-[100%] mt-[10px]">
                        <img class="w-[100%]" src="@/assets/images/setting/alipay1.png" />
                    </div>
                    <p class="flex items-center text-[14px] mt-[20px]">{{ t('alipayCourseTipsTwo1') }}</p>
                    <div class="w-[100%] mt-[10px]">
                        <img class="w-[100%]" src="@/assets/images/setting/alipay2.png" />
                    </div>
                    <div class="w-[100%] mt-[10px]">
                        <img class="w-[100%]" src="@/assets/images/setting/alipay3.png" />
                    </div>
                </div>
            </div>
            <div class="flex mt-[40px]">
                ...
                <div>
                    ...
                    <div class="w-[100%] mt-[10px] flex flex-wrap">
                        <div class="w-[100%]">
                            <img class="w-[100%]" src="@/assets/images/setting/alipay4.png" />
                        </div>
                        <div>
                            <el-row :gutter="20">
                                <el-col :span="6">
                                    <div class="w-[100%]">
                                        <img class="w-[100%]" src="@/assets/images/setting/alipay4_1.jpg" />
                                    </div>
                                </el-col>
                                <el-col :span="6">
                                    <div class="w-[100%]">
                                        <img class="w-[100%]" src="@/assets/images/setting/alipay4_2.jpg" />
                                    </div>
                                </el-col>
                                <el-col :span="6">
                                    <div class="w-[100%]">
                                        <img class="w-[100%]" src="@/assets/images/setting/alipay4_3.jpg" />
                                    </div>
                                </el-col>
                                <el-col :span="6">
                                    <div class="w-[100%]">
                                        <img class="w-[100%]" src="@/assets/images/setting/alipay4_4.jpg" />
                                    </div>
                                </el-col>
                            </el-row>
                        </div>
            ...
            <div class="flex mt-[40px]">
                ...
                <div>
                    ...
                    <div class="w-[100%] mt-[10px]">
                        <img class="w-[100%]" src="@/assets/images/setting/alipay5.png" />
                    </div>
                    <div class="w-[100%] mt-[10px]">
                        <img class="w-[100%]" src="@/assets/images/setting/alipay6.png" />
                    </div>
                    <p class="flex items-center text-[14px] mt-[20px]">{{ t('alipayCourseTipsThree2') }}</p>
                    <div class="w-[100%] mt-[10px]">
                        <img class="w-[100%]" src="@/assets/images/setting/alipay7.png" />
                    </div>
                    <p class="flex items-center text-[14px] mt-[20px]">{{ t('alipayCourseTipsThree3') }}</p>
                    <div class="w-[100%] mt-[10px]">
                        <img class="w-[100%]" src="@/assets/images/setting/alipay8.png" />
                    </div>
                </div>
            </div>
        </el-card>
