                                    ...
                                    <el-table-column :show-overflow-tooltip="true"  min-width="180">
                                        <template #default="{ row }">
                                            <div class="flex items-center cursor-pointer " @click="toMember(row.member.member_id)">
                                                ...
                                                <img class="w-[50px] h-[50px] mr-[10px] rounded-full" v-else src="@/assets/images/member_head.png" alt="">
...
import { t } from '@/lang'
import { getCashOutList, getTransfertype, memberTransfer, memberAudit, getCashOutDetail, getCashOutStatusList, getCashOutStat, memberRemark, memberCheck, memberCancel } from '@/api/member'
