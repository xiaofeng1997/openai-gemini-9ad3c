<template>
    <el-dialog v-model="dialogThemeVisible" title="新增颜色" width="550px" align-center>
        <el-form :model="formData" label-width="120px" ref="formRef" :rules="formRules">
            ...
            <el-form-item label="颜色key" prop="label">
                <el-input v-model="formData.label" class="!w-[250px]" maxlength="20" :disabled="type=='edit'" placeholder="请输入颜色key" />
            </el-form-item>

            <el-form-item label="颜色value" prop="value">
                <el-color-picker v-model="formData.value" show-alpha/>
            </el-form-item>

            <el-form-item label="颜色提示" prop="tip">
...
const formRules = computed(() => {
    return {
        ...
        label: [
            { required: true, message: '请输入颜色key', trigger: 'blur' },
            {
                validator: (rule: any, value: any, callback: any) => {
